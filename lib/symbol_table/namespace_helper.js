...
handle_variable_declaration = function(declaration, namespace){
        ...
        if((subtree === null) || (subtree.title === "EPSILON") || (subtree.children === null)){
            ...
            if(subtree.title === "declarator"){
                ...
                if(first_identifier){
                    ...
                    direct_declarator_p_expr = statement_helper.construct_statement(ddp);
                    var name = {
    ...
    if(primary_type_expr.indexOf("typedef") < 0) traverse_init_declarator_list(init_declarator_list);
};
