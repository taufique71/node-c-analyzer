    ...
    var traverse_init_declarator_list = function(subtree){
        if((subtree === null) || (subtree.title === "EPSILON") || (subtree.children === null)){
            ...
            if(subtree.title === "declarator"){
                var first_identifier = parse_tree_helper.get_first_identifier(subtree);
                var pointer_expr = "";
...
module.exports.handle_variable_declartion = handle_variable_declartion;
...
handle_function_definition = function(function_definition, namespace){
    ...
    if(first_identifier){
        ...
        var first_token = get_first_token(declaration_specifiers, null);
        ...
        var name = {
            ...
            "token": _.clone(first_identifier),
            "name_type": "function",
            "function_return_type": primary_type_expr + pointer_expr + direct_declarator_p_expr,
    ...
    var traverse = function(subtree){
        if((subtree === null) || (subtree.title === "EPSILON") || (subtree.children === null)){
            ...
            if(subtree.title === "enumerator"){
                ...
                namespace["ordinary_id"].push(name);
            }
            else{
                for(var i = 0; i < subtree.children.length; i++){
                    traverse(subtree.children[i]);
        ...
        var traverse = function(subtree){
            if((subtree === null) || (subtree.title === "EPSILON") || (subtree.children === null)){
                ...
                if(subtree.title === "enumerator_list"){
                    populate_enumerators(enumerator_list, namespace);
                }
                else{
                    for(var i = 0; i < subtree.children.length; i++){
                        traverse(subtree.children[i]);
