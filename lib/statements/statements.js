...
var symbol_table = require("../symbol_table/symbol_table");
...
var get_statement_list = function(parse_tree){
    ...
    if(parse_tree === null){
        ...
        var sym_table = symbol_table.get_symbol_table();
        var scope_list = symbol_table.get_scope_list(sym_table);
        stmt_id_tagging(stmt_list, sym_table, scope_list);
        return stmt_list;
    }
}
