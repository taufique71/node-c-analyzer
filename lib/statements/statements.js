...
var get_statement_list = function(parse_tree){
    ...
    var traverse = function(subtree, annotated_scope){
        if((subtree === null) || (subtree.title === "EPSILON") || (subtree.children === null)){
            ...
            if(subtree.title === "iteration_stmt") {
                var iteration_stmt_details = {
                    "initializer": null,
                    "condition": null,
                    "incrementation": null
                };
                ...
                if(first_token.lexeme === "for"){
                    ...
                    else if(subtree.children.length === 7){
                    }
                }
                else if(first_token.lexeme === "do"){
                    var raw_statement = statement_helper.construct_statement(subtree.children[4]);
                    var token_list = statement_helper.get_token_list(subtree.children[4]);
                    iteration_stmt_details["condition"] = {
...
var get_iteration_details = function(parse_tree){
    var traverse = function(parse_tree, annotated_scope){
        if((subtree === null) || (subtree.title === "EPSILON") || (subtree.children === null)){
            return;
        }
        else{
