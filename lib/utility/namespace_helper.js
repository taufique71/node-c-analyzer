...
var populate_namespace_for_labeled_stmt = function(subtree, namespace){
...
var populate_namespace_for_declaration = function(subtree, namespace){
};

var populate_namespace_for_parameter_declaration = function(subtree, namespace){
};

var populate_namespace_for_function_definition = function(subtree, namespace){
};

var populate_namespace_for_struct_or_union_specifier = function(subtree, namespace){
};

var populate_namespace_for_enum_specifier = function(subtree, namespace){
};

var populate_namespace = function(subtree, namespace){
