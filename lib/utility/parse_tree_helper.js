...
var get_list_of_title_matching_subtree = function(subtree, title_to_match){
    var list = [];
    //var traverse = function(subtree){
        //if( subtree.title === title_to_match ){
            //list.push(subtree);
...
module.exports.get_list_of_title_matching_subtree = get_list_of_title_matching_subtree;
